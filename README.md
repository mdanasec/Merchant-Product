...
## Overview
The **Merchant Product Management System** is a robust and scalable web application designed to streamline the management of products by merchants. Developed using Java, Spring Boot, and React.js, this system enables merchants to easily manage their products, including creating, updating, and deleting product listings. The system also supports the filtering of products by brand, category, and merchant ID.
